...
const translations = {
  en: {
    ...
    // What We Do Section
    wwd_badge: "What We Do",
    wwd_title: "Transforming Insurance Operations",
    wwd_subtitle: "Sol-Insure delivers a complete, cloud-native insurance platform that modernizes every aspect of your business—from policy administration to claims processing.",
    wwd_policy_title: "Policy Administration",
    wwd_policy_text: "Manage the entire policy lifecycle with automated workflows, real-time rating, and seamless endorsements—all in one unified platform.",
    wwd_claims_title: "Claims Management",
    wwd_claims_text: "Accelerate claims processing with AI-powered automation, fraud detection, and streamlined adjudication that reduces cycle times by 50%.",
    wwd_billing_title: "Billing & Payments",
    wwd_billing_text: "Flexible billing configurations, automated collections, and integrated payment processing that improves cash flow and customer satisfaction.",
    wwd_analytics_title: "Analytics & Reporting",
    wwd_analytics_text: "Real-time dashboards and customizable reports that provide actionable insights for smarter business decisions and regulatory compliance.",
    wwd_compliance_title: "Regulatory Compliance",
    wwd_compliance_text: "Built-in IFRS-17 compliance, automated regulatory reporting, and audit trails that keep you ahead of evolving requirements.",
    wwd_ai_title: "AI-Powered Intelligence",
    wwd_ai_text: "Machine learning models for risk assessment, predictive analytics, and intelligent automation that drive efficiency across your operations.",
    wwd_cta: "Explore All Features",
  ...
  es: {
    ...
    // What We Do Section
    wwd_badge: "Lo Que Hacemos",
    wwd_title: "Transformando las Operaciones de Seguros",
    wwd_subtitle: "Sol-Insure ofrece una plataforma de seguros completa y nativa en la nube que moderniza cada aspecto de su negocio, desde la administración de pólizas hasta el procesamiento de reclamos.",
    wwd_policy_title: "Administración de Pólizas",
    wwd_policy_text: "Gestione todo el ciclo de vida de las pólizas con flujos de trabajo automatizados, tarificación en tiempo real y endosos sin interrupciones, todo en una plataforma unificada.",
    wwd_claims_title: "Gestión de Reclamos",
    wwd_claims_text: "Acelere el procesamiento de reclamos con automatización impulsada por IA, detección de fraudes y adjudicación optimizada que reduce los tiempos de ciclo en un 50%.",
    wwd_billing_title: "Facturación y Pagos",
    wwd_billing_text: "Configuraciones de facturación flexibles, cobros automatizados y procesamiento de pagos integrado que mejora el flujo de caja y la satisfacción del cliente.",
    wwd_analytics_title: "Análisis e Informes",
    wwd_analytics_text: "Paneles en tiempo real e informes personalizables que proporcionan información procesable para decisiones comerciales más inteligentes y cumplimiento normativo.",
    wwd_compliance_title: "Cumplimiento Regulatorio",
    wwd_compliance_text: "Cumplimiento IFRS-17 incorporado, informes regulatorios automatizados y pistas de auditoría que lo mantienen adelante de los requisitos en evolución.",
    wwd_ai_title: "Inteligencia con IA",
    wwd_ai_text: "Modelos de aprendizaje automático para evaluación de riesgos, análisis predictivo y automatización inteligente que impulsan la eficiencia en todas sus operaciones.",
    wwd_cta: "Explorar Todas las Funciones",
